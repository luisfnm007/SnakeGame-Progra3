...
template <> constexpr inline auto Game::qt_create_metaobjectdata<qt_meta_tag_ZN4GameE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Method 'setDirection'
        QtMocHelpers::MethodData<void(Direction)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
        // Method 'getRows'
        ...
        // Method 'getCellType'
        QtMocHelpers::MethodData<CellType(int) const>(13, 2, QMC::AccessPublic, 0x80000000 | 14, {{
            { QMetaType::Int, 15 },
        }}),
        // Method 'isStarted'
